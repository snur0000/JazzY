...
<html lang="en-US">
    ...
    <body>
        ...
        <div class="content">
            ...
            <p class="radio-align">
               Your tickets have been purchased. Thank you!
            </p>
           <div class="btn-div">
                <a href="index.html"><button class="btn-link">Home<br>
                    </button></a>
                <a href="dashboard.jsp"><button class="btn-link">Dashboard</button></a>
        </div>
